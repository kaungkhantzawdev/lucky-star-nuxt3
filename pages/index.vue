...
useHead({
  ...
  script: [ 
       {src: '/vendor/extra-libs/c3/d3.min.js'},
       {src: '/vendor/extra-libs/c3/c3.min.js'},
       {src: '/vendor/libs/chartist/dist/chartist.min.js'},
       {src: '/vendor/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js'},
       {src: '/vendor/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js'},
       {src: '/vendor/extra-libs/jvector/jquery-jvectormap-world-mill-en.js'},
